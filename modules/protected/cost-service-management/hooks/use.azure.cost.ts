...
export function useAzureCost() {
    ...
    const [presetRange, setPresetRange] = useState<AzureCostPresetRange>(DEFAULT_PRESET_RANGE);
    const [customGranularity, setCustomGranularity] = useState<AzureCostGranularity>("Daily");
    ...
    const currentGranularity: AzureCostGranularity = chartParams.granularity || "Monthly";
    ...
    const {
        ...
        queryKey: queryKeys.azureCost.chart(chartParams as Record<string, unknown>),
