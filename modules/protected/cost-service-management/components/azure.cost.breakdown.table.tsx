...
import { Table, ListFilter } from "lucide-react";
        ...
        <div className="overflow-hidden rounded-2xl border border-[var(--color-bdc-primary)] bg-[var(--color-bgc-app)] shadow-sm">
            ...
            <div className="w-full overflow-x-auto">
                <table className="w-full text-left text-sm">
                    <thead className="bg-gray-50/80 text-xs uppercase text-gray-500 dark:bg-gray-800/40 dark:text-gray-400">
                        <tr>
                            <th scope="col" className="px-6 py-3 font-semibold">{t("colIndex")}</th>
                            <th scope="col" className="px-6 py-3 font-semibold">{t("colDate")}</th>
                            <th scope="col" className="px-6 py-3 font-semibold">{t("colCost")}</th>
                            <th scope="col" className="px-6 py-3 font-semibold">{t("colShare")}</th>
                        </tr>
                    </thead>
                            ...
                            data.map((row, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 font-bold text-blue-600 dark:text-blue-400">
                                        {formatCostCurrency(row.cost, row.currency || currency)}
                                    </td>
