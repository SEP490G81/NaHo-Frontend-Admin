...
export default function NodeManagementView({ params }: NodeManagementViewProps) {
    ...
    const [editVocabularyQuestionNodeId, setEditVocabularyQuestionNodeId] = useState<number | null>(null);
    ...
    const handleEditNode = (node: LearningPathNodeListItemResponse) => {
        if (node.nodeType === "SPEAKING_QUESTION") {
            ...
            setEditVocabularyQuestionNodeId(node.id);
