                ...
                <table className="w-full table-auto">
                    <thead className="bg-bgc-app sticky top-0 z-10">
                        <tr className="border-bdc-primary border-b">
                            ...
                            <th className={headClass}>Từ vựng</th>
                            ...
                            <tr>
                                <td colSpan={6} align="center" className="py-16">
                                    <div className="flex flex-col items-center justify-center text-text-muted">
                                        <Typography>Không có dữ liệu từ vựng.</Typography>
                                    </div>
                                </td>
                            </tr>
                        ) : (
                            vocabularies.map((vocabulary, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className={`font-semibold ${cellClass}`}>{vocabulary.japanese}</td>
                                        <td className={cellClass}>{vocabulary.reading || "-"}</td>
                                        <td className={cellClass}>{vocabulary.vietnameseMeaningText || "-"}</td>
                                        <td className={cellClass}>{vocabulary.englishMeaningText || "-"}</td>
                                        <td className={cellClass + " text-center"}>
                                            <div className="flex items-center justify-center gap-2">
                                                <Tooltip title="Sửa">
                                                    <IconButton 
                                                        size="small" 
                                                        onClick={() => onUpdateClick(vocabulary.id)}
