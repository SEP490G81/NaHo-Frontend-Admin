...
import { X, Edit3, AlertCircle, Sparkles, Layers, Sliders, ShieldCheck } from "lucide-react";
...
export function SubscriptionPlanEditModal() {
    ...
    const [sampleAnswerEnabled, setSampleAnswerEnabled] = useState<boolean>(false);
    ...
    useEffect(() => {
        if (editingPlan) {
            ...
            setDurationDays(editingPlan.durationDays !== null && editingPlan.durationDays !== undefined ? String(editingPlan.durationDays) : "");
            setDailySpeakingLimit(editingPlan.dailySpeakingQuestionEvaluationLimit ?? 0);
            setMaxRecordingSecs(editingPlan.maxSpeakingQuestionRecordingSeconds ?? 0);
    ...
    return (
        <Dialog
            ...
            slotProps={{
                paper: {
                    className: "rounded-3xl dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-2xl",
                },
            }}
        >
            <form onSubmit={handleSubmit}>
                {/* Header */}
                <DialogTitle className="flex items-center justify-between font-bold text-gray-900 dark:text-gray-100 px-6 py-4 border-b border-gray-100 dark:border-gray-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold">
                                {t("title", { id: editingPlan.id, tier: editingPlan.code })}
                            </h2>
                ...
                <DialogContent className="space-y-6 px-6 py-6 max-h-[75vh] overflow-y-auto">
                    {errorMessage && (
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-2 text-xs font-extrabold uppercase tracking-wider text-pink-600 dark:text-pink-400">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1 md:col-span-2">
                                ...
                                <TextField
                                    ...
                                    size="small"
                                    value={durationDays}
                                    placeholder={t("fields.durationDaysPlaceholder")}
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1">
                                <label className="text-xs font-bold text-gray-700 dark:text-gray-300">
                                    {t("fields.dailySpeakingQuestionEvaluationLimit")}
                                </label>
                                <TextField
                                    type="number"
                                    fullWidth
                                    ...
                                    onChange={(e) => setDailySpeakingLimit(Number(e.target.value))}
                                    sx={inputSx}
                                />
                            </div>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-bold text-gray-700 dark:text-gray-300">
                                    {t("fields.maxSpeakingQuestionRecordingSeconds")}
                                </label>
                                <TextField
                                    type="number"
                                    fullWidth
                                    ...
                                    onChange={(e) => setMaxRecordingSecs(Number(e.target.value))}
                                    sx={inputSx}
                                />
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <TextField
                                    ...
                                    onChange={(e) => setMaxConcurrentAi(Number(e.target.value))}
                                    sx={inputSx}
                                />
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <TextField
                                    ...
                                    size="small"
                                    value={maxTurnsPerAi}
                                    onChange={(e) => setMaxTurnsPerAi(Number(e.target.value))}
                                    sx={inputSx}
                                />
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <TextField
                                    ...
                                    onChange={(e) => setMaxAiSpeakingSecs(Number(e.target.value))}
                                    sx={inputSx}
                                />
                            </div>
                        </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/40 p-4 border border-gray-100 dark:border-gray-800 flex items-center justify-between">
                            <div>
                                <span className="text-xs font-bold text-gray-800 dark:text-gray-200 block">
                                    {t("fields.sampleAnswerEnabled")}
                                </span>
                                <span className="text-[11px] text-gray-500 block">
                                    Cho phép người dùng sử dụng gói này xem đáp án gợi ý mẫu trong quá trình học.
                                </span>
                            </div>
                            <FormControlLabel
                                control={
                                    <Switch
                                        ...
                                        onChange={(e) => setSampleAnswerEnabled(e.target.checked)}
                                        color="primary"
                                    />
                                }
                                label=""
                ...
                <DialogActions className="px-6 py-4 border-t border-gray-100 dark:border-gray-800">
                    <Button onClick={closeEditPlanModal} variant="outlined" color="inherit">
                        {t("cancel")}
                    </Button>
                    <Button
                        type="submit"
                        ...
                        className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-bold rounded-xl px-6"
                    >
