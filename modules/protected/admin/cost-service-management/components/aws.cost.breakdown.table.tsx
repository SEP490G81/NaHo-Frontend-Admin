...
interface AwsCostBreakdownTableProps {
    readonly data: FormattedAwsChartPoint[];
    readonly currency?: string;
    readonly isLoading?: boolean;
}

export function AwsCostBreakdownTable({
    data,
    currency = "USD",
    isLoading = false,
}: AwsCostBreakdownTableProps) {
    const t = useTranslations("costServiceManagement.tableAws");
