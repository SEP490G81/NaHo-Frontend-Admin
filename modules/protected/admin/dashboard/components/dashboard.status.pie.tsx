...
export function DashboardStatusPie({
    ...
    return (
        ...
        >
            <div className="absolute top-0 right-0 left-0 h-1 bg-gradient-to-r from-pink-400 via-[var(--color-bgc-highlight)] to-purple-400" />
            ...
            <div className="flex h-64 w-full flex-1 items-center justify-center pt-2">
                {isLoading ? (
                    <Skeleton
                        variant="circular"
                        width={180}
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 pt-2 text-xs">
                {data.map((item) => (
                    <div
                        key={item.name}
