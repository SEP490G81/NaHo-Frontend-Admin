...
import { UserSubscriptionTableRow } from "./user.subscription.table.row";
...
export function UserSubscriptionTable({
    ...
    return (
        <div className="w-full overflow-x-auto rounded-lg border border-[var(--color-bdc-primary)] bg-[var(--color-bgc-app)]">
            <table className="w-full table-auto">
                <thead className="bg-bgc-app sticky top-0 z-10">
                    <tr className="border-bdc-primary border-b">
                        ...
                        <th className={headClass}>Gói cước</th>
                        <th className={headClass}>{t("actions")}</th>
                    </tr>
                </thead>
                <tbody>
                    {sortedUsers.map((user, index) => (
                        <UserSubscriptionTableRow
                            key={user.id}
                            user={user}
                            index={index}
