...
- Xóa cho tôi option trạng thái `đã xóa` và vai trò `quản trị viên` trong phần search box của user:
  `modules/protected/admin/users/components/user.search.box.tsx`
