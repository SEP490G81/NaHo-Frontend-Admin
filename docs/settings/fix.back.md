...
- Cái nút `trở lại` trong phần setting `modules/protected/shared/settings/components/settings.sidebar.tsx` đang bị một
  vấn đề là: nếu như tôi vào trang /settings, rồi ấn vào các nav trên sidebar của settings như /settings/account... thì
  ấn nút back nó sẽ không quay lại trang trước mà sẽ quay lại trang /settings
- Bạn hãy fix cho tôi để nó quay về trang mà không phải settings
