...
- Sửa lại các tiêu đề của sidebar thành các key trong next-intl
- Tôi muốn thêm 1 phần tử sidebar là "Quản lý người dùng" ở vị trí thứ 2, sử dụng icon của lucide react cho đồng nhất,
  đường dẫn tới trang đó là /users. Title của trang đó là `Quản lý người dùng`
- Trang đó bạn cứ để blank cho tôi
